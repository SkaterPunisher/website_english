...
export async function generateMetadata({
  ...
  return {
    title:
      'Сильные преподаватели в онлайн студии английского языка Зыкова Оксана § Advanced English',
    description:
      'Репетиторы и преподаватели онлайн студии английского языка Зыкова Оксана § Advanced English | Сильные учителя | Скидки до 30% | Попробуйте бесплатно!',
  }
}
