...
export async function generateMetadata({
  ...
  return {
    title:
      'Стоимость уроков английского языка онлайн/оффлайн от 350 рублей ‹ Advenced English | Зыкова Оксана',
    description:
      'Стоимость занятий английским языком онлайн ⠀➤ Сильные преподаватели ⠀➤ Скидки до 30% ☑️Попробуйте бесплатно! Advenced English | Зыкова Оксана',
  }
}
