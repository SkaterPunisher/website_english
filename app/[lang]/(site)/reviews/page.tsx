...
export async function generateMetadata({
  ...
  return {
    title:
      'Стоит ли учить английский в онлайн студии, отзывы наших учеников ‹ Инглекс Advenced English | Зыкова Оксана',
    description:
      'Отзывы об онлайн студии английского Advenced English | Зыкова Оксана⠀➤ Сильные преподаватели Скидки до 30% ☑️Попробуйте бесплатно! ',
  }
}
